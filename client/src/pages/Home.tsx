...
import { ArrowRight, Database, Zap, Download, Globe, BarChart3, Network, Cloud, Server, Waves, Cpu, Shield, User, LogIn } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* 上层：核心概念区域 - 带流动背景 */}
      <div className="pt-32 pb-16 border-b border-border/50 relative overflow-hidden">
        {/* 流动背景 */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12 animate-fade-in-up">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              汇聚全球海洋数据，赋能智慧决策。一站式海洋数据服务平台，连接数据、知识与应用。
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* 海洋可信数据底座 - 左侧拉长 */}
            <div className="p-8 rounded-xl bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border-2 border-blue-500/30 backdrop-blur-sm card-lift animate-fade-in-left animation-delay-100 lg:col-span-1">
            ...
            {/* 新型海洋数据基础设施 - 右侧拉长 */}
            <div className="p-8 rounded-xl bg-gradient-to-br from-green-500/10 to-emerald-500/10 border-2 border-green-500/30 backdrop-blur-sm card-lift animate-fade-in-right animation-delay-200 lg:col-span-1">
              <div className="flex items-start gap-4 mb-4">
      ...
      <div className="py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {/* 左列：海洋数据服务平台 */}
            <div className={`flex flex-col p-8 rounded-xl bg-gradient-to-br ${serviceModules[0].color} border-2 ${serviceModules[0].borderColor} backdrop-blur-sm card-lift animate-fade-in-left animation-delay-300`}>
              <div className="mb-6">
            ...
            <div className="flex flex-col items-center justify-center animate-fade-in-up animation-delay-400">
              {/* 大脑图标 */}
              <div className="w-48 h-48 rounded-full bg-gradient-to-br from-primary/40 to-accent/40 border-2 border-accent/60 flex items-center justify-center backdrop-blur-sm hover:border-accent hover:shadow-xl hover:shadow-accent/30 transition-all duration-300 mb-8 animate-float">
            ...
            {/* 右列：海洋数据资源池 */}
            <div className={`flex flex-col p-8 rounded-xl bg-gradient-to-br ${serviceModules[1].color} border-2 ${serviceModules[1].borderColor} backdrop-blur-sm card-lift animate-fade-in-right animation-delay-500`}>
              <div className="mb-6">
      ...
      {/* 支撑层信息 */}
      <div className="border-t border-border/50 bg-gradient-to-b from-secondary/10 to-background py-8">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* 国家海洋可信数据空间 */}
            <div className="p-6 rounded-lg bg-card border border-border hover:border-accent/50 transition-colors card-lift animate-fade-in-left animation-delay-600">
              <div className="flex items-center gap-3 mb-3">
                <Cloud className="w-5 h-5 text-accent flex-shrink-0" />
                <h3 className="font-semibold">国家海洋可信数据空间</h3>
              </div>
              <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            {/* 中国移动基础设施能力 */}
            <div className="p-6 rounded-lg bg-card border border-border hover:border-accent/50 transition-colors card-lift animate-fade-in-right animation-delay-600">
              <div className="flex items-center gap-3 mb-3">
                <Server className="w-5 h-5 text-accent flex-shrink-0" />
                <h3 className="font-semibold">中国移动基础设施能力</h3>
              </div>
              <p className="text-sm text-muted-foreground leading-relaxed">
